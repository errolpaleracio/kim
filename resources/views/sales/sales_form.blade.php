            ...
            <div class="card-body">
                <form method="POST" action="{{ route('products.store') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="unit_price" type="text" class="form-control @error('unit_price') is-invalid @enderror" name="unit_price" value="{{ old('unit_price') }}" required autocomplete="unit_price">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="critical_lvl" type="text" class="form-control @error('critical_lvl') is-invalid @enderror" name="critical_lvl" required autocomplete="critical_lvl">
